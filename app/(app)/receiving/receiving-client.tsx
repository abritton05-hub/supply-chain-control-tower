...
import { getCurrentUserRecord } from '@/lib/state/mock-users';
...
export function ReceivingClient({ inventory, recentReceipts }: Props) {
  ...
  function submitReceipt() {
    ...
    startTransition(async () => {
      ...
      } as ReceiveInventoryInput & { performed_by: string });
          ...
          {!form.is_supply ? (
            <>
              <div className="mb-4">
                ...
                />
                <p className="mt-2 text-xs text-slate-500">
                  Receiving can only be posted against existing inventory items unless Receive as Supply is checked.
                </p>
              </div>
