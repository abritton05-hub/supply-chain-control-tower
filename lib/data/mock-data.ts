...
const fullAdminPermissions = {
  ...
  canViewFinancialFreight: true,
  canAccessSettings: true,
};

export const users: AppUser[] = [
  { id: 'u1', name: 'Anthony Britton', email: 'ABritton05@gmail.com', login: 'ABritton05@gmail.com', password: 'Hank45@54', role: 'System Admin', active: true, department: 'Logistics', accessLevel: 'Administrator', permissions: fullAdminPermissions, lastLogin: '2026-03-22T07:45:00Z', lastLogout: '2026-03-21T18:10:00Z' },
  { id: 'u2', name: 'M. Ortega', email: 'ops@dai.example', login: 'ops@dai.example', password: 'OpsManager#2026', role: 'Operations Manager', active: true, department: 'Operations', accessLevel: 'Manager', permissions: { canView: true, canEditRecords: true, canDeleteArchive: false, canManageUsers: false, canApproveChanges: true, canViewFinancialFreight: true, canAccessSettings: false }, lastLogin: '2026-03-17T06:42:00Z', lastLogout: '2026-03-17T16:55:00Z' },
  { id: 'u3', name: 'L. Kim', email: 'warehouse@dai.example', login: 'warehouse@dai.example', password: 'Warehouse#2026', role: 'Warehouse', active: true, department: 'Warehouse', accessLevel: 'Operational', permissions: { canView: true, canEditRecords: true, canDeleteArchive: false, canManageUsers: false, canApproveChanges: false, canViewFinancialFreight: false, canAccessSettings: false }, lastLogin: '2026-03-17T07:03:00Z', lastLogout: '2026-03-17T15:44:00Z' },
  { id: 'u4', name: 'D. Young', email: 'purchasing@dai.example', login: 'purchasing@dai.example', password: 'Purchasing#2026', role: 'Purchasing', active: true, department: 'Supply Chain', accessLevel: 'Operational', permissions: { canView: true, canEditRecords: true, canDeleteArchive: false, canManageUsers: false, canApproveChanges: true, canViewFinancialFreight: true, canAccessSettings: false }, lastLogin: '2026-03-17T07:30:00Z', lastLogout: '2026-03-17T16:20:00Z' },
  { id: 'u5', name: 'A. Viewer', email: 'viewer@dai.example', login: 'viewer@dai.example', password: 'Viewer#2026', role: 'Viewer', active: true, department: 'Executive', accessLevel: 'Read Only', permissions: { canView: true, canEditRecords: false, canDeleteArchive: false, canManageUsers: false, canApproveChanges: false, canViewFinancialFreight: true, canAccessSettings: false }, lastLogin: '2026-03-16T09:00:00Z' },
];
...
export const departments = ['Assembly', 'Warehouse', 'Service', 'Engineering', 'Logistics'];
...
export const transactions: InventoryTransaction[] = [
  ...
  { id: 't5', date: '2026-03-04', itemId: 'INV-1004', serialNumber: '-', movementType: 'CYCLE COUNT', quantity: 12, fromLocation: 'Service Cage', toLocation: 'Service Cage', reference: '-', workOrder: '-', notes: 'Cycle count verified', performedByUserId: 'u1', performedByName: 'Anthony Britton', performedByRole: 'System Admin', performedAt: '2026-03-04T08:40:00Z' },
];

export const auditLog: AuditLogEntry[] = [
  { id: 'a1', entityType: 'item', entityId: 'INV-1001', actionType: 'UPDATE', fieldName: 'safetyStock', oldValue: '20', newValue: '25', changedByUserId: 'u1', changedByName: 'Anthony Britton', changedAt: '2026-03-01T12:30:00Z' },
  ...
  { id: 'a4', entityType: 'user', entityId: 'u4', actionType: 'OVERRIDE', fieldName: 'permissions', oldValue: 'Standard buyer access', newValue: 'Buyer + freight visibility', changedByUserId: 'u1', changedByName: 'Anthony Britton', changedAt: '2026-03-04T14:22:00Z' },
];
...
export const vendors: Vendor[] = [
  { id: 'v1', vendorName: 'Apex Electronics', category: 'Electronics', contact: 'J. Morris', phone: '555-102-2390', email: 'jmorris@apex.example', leadTimeDays: 14, preferred: true, paymentTerms: 'Net 30', orderingMethod: 'PO + Email', creditCardAccepted: true, poRequired: true, notes: 'Primary PCB source' },
  { id: 'v2', vendorName: 'PowerGrid Supply', category: 'Power', contact: 'D. Young', phone: '555-203-8821', email: 'dyoung@powergrid.example', leadTimeDays: 10, preferred: true, paymentTerms: 'Net 15', orderingMethod: 'EDI + PO', creditCardAccepted: false, poRequired: true, notes: 'Dual source available' },
  { id: 'v3', vendorName: 'WireTech', category: 'Cable & Harness', contact: 'K. Liu', phone: '555-888-1222', email: 'kliu@wiretech.example', leadTimeDays: 7, preferred: false, paymentTerms: 'Net 30', orderingMethod: 'Email + Forecast', creditCardAccepted: true, poRequired: true, notes: 'MOQ on custom harnesses' },
];
