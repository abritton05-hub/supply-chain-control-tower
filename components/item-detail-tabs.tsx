...
const tabs = ['Overview', 'Purchasing', 'Transactions', 'Receiving History', 'Shipping History', 'Serial Numbers', 'Open POs', 'Projects / Builds', 'Vendor Info'] as const;
